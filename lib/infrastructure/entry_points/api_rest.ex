defmodule LatencySimulator.Infrastructure.EntryPoint.ApiRest do
  @moduledoc """
  Access point to the rest exposed services
  """
  alias LatencySimulator.Utils.DataTypeUtils
  alias LatencySimulator.Infrastructure.EntryPoint.ErrorHandler
  require Logger
  use Plug.Router
  use Timex
  ...
  plug(Plug.Telemetry, event_prefix: [:latency_simulator, :plug])
  plug(:dispatch)
  ...
  forward(
    ...
    init_opts:
      PlugCheckup.Options.new(
        json_encoder: Jason,
        checks: LatencySimulator.Infrastructure.EntryPoint.HealthCheck.checks()
      )
  )
