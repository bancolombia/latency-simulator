defmodule LatencySimulator.Utils.CustomTelemetry do
  alias LatencySimulator.Utils.DataTypeUtils
  alias LatencySimulator.Utils.CustomTelemetry
  import Telemetry.Metrics

  @service_name Application.compile_env!(:latency_simulator, :custom_metrics_prefix_name)
  ...
  def handle_custom_event([:latency_simulator, :plug, :stop], measures, metadata, _) do
    :telemetry.execute(
